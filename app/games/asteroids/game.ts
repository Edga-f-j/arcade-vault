...
export function startGame(
  ...
  class Asteroid {
    ...
    vx: number; vy: number; rotSpeed: number; rot: number;
    verts: [number, number][]; dead = false;
  ...
  class PowerUp {
    x: number; y: number; vx: number; vy: number;
    radius = 12; ttl = POWERUP_TTL; dead = false;
  ...
  class Ship {
    ...
    radius = 12; thrusting = false; invincible = 3;
    shootCooldown = 0; dead = false; tripleShot = 0;
  ...
  class Particle {
    x: number; y: number; vx: number; vy: number;
    life: number; ttl: number; dead = false;
  ...
  function initGame() {
    ...
    powerUpSpawned = false; killsSinceSpawn = 0;
